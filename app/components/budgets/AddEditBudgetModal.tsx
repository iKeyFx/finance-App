...
export default function AddEditBudgetModal({
  ...
  const [theme, setTheme] = useState(
    mode === "edit" ? budget!.theme : (BUDGET_THEMES[0]?.value ?? "")
  )
  ...
  const selectedTheme = BUDGET_THEMES.find((t) => t.value === theme)
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {/* Budget Category */}
          <div>
            <label className="text-[14px] font-bold text-grey-900 mb-2 block">
              Budget Category
            </label>
            <div className="relative">
              <button
                type="button"
                onClick={() => { setCategoryOpen((o) => !o); setThemeOpen(false) }}
          ...
          <div>
            ...
            <div className="relative">
              <button
                type="button"
                onClick={() => { setThemeOpen((o) => !o); setCategoryOpen(false) }}
                className="w-full h-[45px] px-4 rounded-lg border border-beige-500 text-[14px] text-grey-900 flex items-center justify-between hover:border-grey-900 transition-colors cursor-pointer bg-white"
              >
                      ...
                      return (
                        <li key={t.value}>
                          ...
                          >
                            ...
                            {alreadyUsed && (
                              <span className="text-[12px] text-grey-500">Already used</span>
                            )}
                          </button>
                        </li>
                      )
